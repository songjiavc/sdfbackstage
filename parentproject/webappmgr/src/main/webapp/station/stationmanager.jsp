...
<body class="easyui-layout">
	...
	<div data-options="region:'center',title:'North Title',split:true" style="height:100px;">
		<table id="accountDataGrid" class="easyui-datagrid" title="用户列表"  data-options="toolbar:toolbar" >
		</table>
	</div>
	    <!-- 添加权限弹框 -->
  	<div id="addAccount" class="easyui-dialog" title="添加用户" style="width:480px;height:350px;padding:10px;"
		...
		<form id="addAccountForm" method="post" >
	        ...
	        <div class="ftitle">
	            <label for="code">站点号:</label>
	            <input class="easyui-validatebox textbox" type="text" name="stationCode"  data-options="required:true,validType:['englishOrNum','length[0,20]']""
	              missingMessage="站点号不可以为空" invalidMessage="用户编码长度不可以超过20个字符"></input>
	        </div>
	        
	        <div class="ftitle">
	           <label for="provinceCode">省:</label>
	           <input id="provinceCode" class="easyui-combobox" data-options="
			        valueField: 'id',
			        textField: 'text',
			        url: 'get_data1.php',
				...
				<input id="cityCode" class="easyui-combobox" data-options="valueField:'id',textField:'text'">
	        </div>
	        
	        <div class="ftitle">
	            <label for="name" >站主姓名:</label>
	            <input class="easyui-validatebox textbox" type="text" name="name"  data-options="required:true,validType:['CHS','length[0,20]']"  missingMessage="用户真实姓名"></input>
	        </div>
	        <div class="ftitle">
